		...
		<div id="wrapper">
			<div id="header">
				<div class="site">
					...
					<div class="title">
						<div class="name"><?php echo strlen($db->siteName) > 0 ? $db->siteName : "FoodConnection"?></div>
						<div class="sub"><?php echo $db->alias?></div>
					</div>
			...
			<div id="container">
				...
				<div class="result">
					<table>
						...
						<tbody>
							...
							<tr data="<?php echo $row["id"]?>">
								<td class="col-remove col-center"><span class="remove">&times;</span></td>
								<td class="col-message col-left col-click">
									<div class="messages"><?php echo preg_replace("/[\r|\n]+/", "", $message)?></div>
								</td>
								<td class="col-ip col-center col-click"><?php echo $row["ip"]?></td>
								<td class="col-browser col-center col-click"><?php echo $row["browser"]?></td>
								<td class="col-os col-center col-click"><?php echo $row["os"]?></td>
								<td class="col-date col-center col-click"><?php echo $date?></td>
							</tr>
							<?php
							}
							?>
				...
				?>
				<div class="no-data<?php echo (count($result) > 0 ? "" : " active")?>">No data</div>
